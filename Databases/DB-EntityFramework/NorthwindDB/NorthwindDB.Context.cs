...
namespace NorthwindDB
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_GetTotalIncome_Result> usp_GetTotalIncomes(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            var supplierNameParameter = supplierName != null ?
                new ObjectParameter("supplierName", supplierName) :
                new ObjectParameter("supplierName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetTotalIncome_Result>("usp_GetTotalIncomes", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
