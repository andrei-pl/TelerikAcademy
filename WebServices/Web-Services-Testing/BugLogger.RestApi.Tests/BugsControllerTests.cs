    ...
    public class BugsControllerTests
    {
        ...
        public void GetByDate_WhenValid_ShouldReturnCollectionMemberWithCorrespondingStatus()
        {
            ...
            var expected = bugs.AsQueryable()
                               .Where(b => b.LogDate.GetValueOrDefault().Day == DateTime.Now.Day &&
                                           b.LogDate.GetValueOrDefault().Month == DateTime.Now.Month &&
                                           b.LogDate.GetValueOrDefault().Year == DateTime.Now.Year)
                               .Select(b => b.LogDate)
                               .ToList();
        ...
        public void AddBug_WhenBugTextIsValid_ShouldBeAddedToRepoWithLogDateAndStatusPending()
        {
            ...
            Assert.IsNotNull(bugInDb.LogDate.GetValueOrDefault());
